...
{application,leo_gateway,
             [{description,"LeoFS Gateway Server"},
              ...
              {modules,[leo_gateway_api,leo_gateway_app,
                        ...
                        leo_large_object_put_handler,leo_large_object_worker,
                        leo_nfs_file_handler,leo_nfs_mount3_server,
                        leo_nfs_mount3_svc,leo_nfs_mount3_xdr,
                        leo_nfs_proto3_server,leo_nfs_proto3_svc,
                        leo_nfs_proto3_xdr,leo_nfs_readdir_state_behaviour,
                        leo_nfs_readdir_state_ets_server,
                        leo_nfs_state_behaviour,leo_nfs_state_ets,
                        leo_nginx_conf_parser,leo_nlm_lock_behaviour,
                        leo_nlm_lock_handler_common,leo_nlm_lock_handler_ets,
                        leo_nlm_proto4_server,leo_nlm_proto4_svc,
                        leo_nlm_proto4_xdr,leofs]},
              {registered,[]},
